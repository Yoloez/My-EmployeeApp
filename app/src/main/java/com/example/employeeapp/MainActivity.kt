...
class MainActivity : AppCompatActivity() {
    ...
    override fun onResume() {
        super.onResume()
        // Refresh data ketika kembali dari DetailEmployeeActivity
        loadEmployees()
    }
    ...
    private fun loadEmployees() {
        ...
        response.enqueue(object : Callback<EmployeeResponse> {
            override fun onResponse(
                ...
                binding.lvEmployee.onItemClickListener =
    ...
    private fun createEmployee(name: String, salary: Int, age: Int, onSuccess: () -> Unit) {
        ...
        client.createEmployee(body).enqueue(object : Callback<DetailEmployeeResponse> {
            override fun onResponse(
                c: Call<DetailEmployeeResponse>,
                r: Response<DetailEmployeeResponse>
            ) {
                if (!r.isSuccessful) {
                    Toast.makeText(
                        this@MainActivity,
